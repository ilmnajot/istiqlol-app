...
@Service
public class StudentMonthlyFeeGoogleSheetImpl implements StudentMonthlyFeeGoogleSheet {
    ...
    @Value("${google.sheets.student-fee.range}")
    private String studentFeeRange;


    @Override
    public void recordMonthlyFee(MonthlyFee monthlyFee) {
        ...
        try {
            List<Object> row = List.of(
                    monthlyFee.getId(),
                    monthlyFee.getStudentContract() != null ? monthlyFee.getStudentContract().getId() : 0L,
                    monthlyFee.getStudentContract() != null ? monthlyFee.getStudentContract().getStudentFullName() : "",
                    ...
                    monthlyFee.getCutAmount() != null ? monthlyFee.getCutAmount() : 0.0,
                    monthlyFee.getReason() != null ? monthlyFee.getReason() : "",
                    monthlyFee.getTariffName() != null ? monthlyFee.getTariffName() : "",
                    monthlyFee.getCategory() != null && monthlyFee.getCategory().getCategoryStatus() != null ? monthlyFee.getCategory().getCategoryStatus().name() : "",
                    monthlyFee.getCategory() != null && monthlyFee.getCategory().getName() != null ? monthlyFee.getCategory().getName() : "",
            ...
            this.sheetService
                    .spreadsheets()
                    .values()
                    .append(studentTransactionsSheetId, studentFeeRange, valueRange)
    ...
    public void initializeSheet() {
        try {
            ValueRange headerRange = this.sheetService
                    .spreadsheets()
                    .values()
                    .get(studentTransactionsSheetId, studentFeeRange)
                    .execute();
    ...
    private void bulkyAllMonthlyFee() throws IOException {
        List<MonthlyFee> list = this.monthlyFeeRepository.findAll();
        if (list.isEmpty()) {
        ...
        sheetService.spreadsheets().values()
                .append(studentTransactionsSheetId, studentFeeRange, body)
                .setValueInputOption(USER_ENTERED)
                .setInsertDataOption(INSERT_ROWS)
                .execute();
    ...
    public void updateMonthlyFee(MonthlyFee monthlyFee) {
        ...
        try {
            ...
            String searchRange = sheetName + "!A2:R";
    ...
    private String getSheetName() {
        return this.studentFeeRange.split("!")[0];
    }
}
